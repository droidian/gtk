...
#ifndef GTK_TEXT_INPUT_INTERFACE
#define GTK_TEXT_INPUT_INTERFACE
/**
...
#endif
#ifndef GTK_TEXT_INPUT_MANAGER_INTERFACE
#define GTK_TEXT_INPUT_MANAGER_INTERFACE
/**
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input,
			 GTK_TEXT_INPUT_DESTROY, NULL, wl_proxy_get_version((struct wl_proxy *) gtk_text_input), WL_MARSHAL_FLAG_DESTROY);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input,
			 GTK_TEXT_INPUT_ENABLE, NULL, wl_proxy_get_version((struct wl_proxy *) gtk_text_input), 0, serial, show_input_panel);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input,
			 GTK_TEXT_INPUT_DISABLE, NULL, wl_proxy_get_version((struct wl_proxy *) gtk_text_input), 0);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input,
			 GTK_TEXT_INPUT_SET_SURROUNDING_TEXT, NULL, wl_proxy_get_version((struct wl_proxy *) gtk_text_input), 0, text, cursor, anchor);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input,
			 GTK_TEXT_INPUT_SET_CONTENT_TYPE, NULL, wl_proxy_get_version((struct wl_proxy *) gtk_text_input), 0, hint, purpose);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input,
			 GTK_TEXT_INPUT_SET_CURSOR_RECTANGLE, NULL, wl_proxy_get_version((struct wl_proxy *) gtk_text_input), 0, x, y, width, height);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input,
			 GTK_TEXT_INPUT_COMMIT, NULL, wl_proxy_get_version((struct wl_proxy *) gtk_text_input), 0);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input_manager,
			 GTK_TEXT_INPUT_MANAGER_DESTROY, NULL, wl_proxy_get_version((struct wl_proxy *) gtk_text_input_manager), WL_MARSHAL_FLAG_DESTROY);
}
...
gtk_text_input_manager_get_text_input(struct gtk_text_input_manager *gtk_text_input_manager, struct wl_seat *seat)
{
	...
	id = wl_proxy_marshal_flags((struct wl_proxy *) gtk_text_input_manager,
			 GTK_TEXT_INPUT_MANAGER_GET_TEXT_INPUT, &gtk_text_input_interface, wl_proxy_get_version((struct wl_proxy *) gtk_text_input_manager), 0, NULL, seat);
